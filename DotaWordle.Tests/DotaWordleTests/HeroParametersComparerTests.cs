...
public class HeroParametersComparerTests
{
    ...
    public void Setup()
    {
        ...
        secondHero = new Hero
        {
            ...
            Name = "Bane",
            AttackType = "Ranged",
            StartingArmor = 4.8333335f,
            StartingDamageMin = -1,
            StartingDamageMax = 5,
            StartingMovespeed = 305,
            AttackRange = 400,
            StrengthBase = 23,
            AgilityBase = 23,
            IntelligenceBase = 23,
    ...
    public void ShouldCorrectlyCompareHeroes()
    {
        ...
        var expectedResult = new HeroComparison
        {
            ...
            StartingArmorComparision = 1,
            StartingDamageMinComparision = 1,
            StartingDamageMaxComparision = 1,
            StartingMovespeedComparision = 1,
